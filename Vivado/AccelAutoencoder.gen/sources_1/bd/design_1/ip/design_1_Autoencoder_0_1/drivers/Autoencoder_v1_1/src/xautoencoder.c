...
void XAutoencoder_Set_DataDimension(XAutoencoder *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XAutoencoder_WriteReg(InstancePtr->Control_BaseAddress, XAUTOENCODER_CONTROL_ADDR_DATADIMENSION_DATA, Data);
}

u32 XAutoencoder_Get_DataDimension(XAutoencoder *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XAutoencoder_ReadReg(InstancePtr->Control_BaseAddress, XAUTOENCODER_CONTROL_ADDR_DATADIMENSION_DATA);
    return Data;
}

void XAutoencoder_Set_HiddenDimension(XAutoencoder *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XAutoencoder_WriteReg(InstancePtr->Control_BaseAddress, XAUTOENCODER_CONTROL_ADDR_HIDDENDIMENSION_DATA, Data);
}

u32 XAutoencoder_Get_HiddenDimension(XAutoencoder *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XAutoencoder_ReadReg(InstancePtr->Control_BaseAddress, XAUTOENCODER_CONTROL_ADDR_HIDDENDIMENSION_DATA);
    return Data;
}
...
void XAutoencoder_Set_EncoderWeights(XAutoencoder *InstancePtr, u64 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XAutoencoder_WriteReg(InstancePtr->Control_bus_BaseAddress, XAUTOENCODER_CONTROL_BUS_ADDR_ENCODERWEIGHTS_DATA, (u32)(Data));
    XAutoencoder_WriteReg(InstancePtr->Control_bus_BaseAddress, XAUTOENCODER_CONTROL_BUS_ADDR_ENCODERWEIGHTS_DATA + 4, (u32)(Data >> 32));
}

u64 XAutoencoder_Get_EncoderWeights(XAutoencoder *InstancePtr) {
    u64 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XAutoencoder_ReadReg(InstancePtr->Control_bus_BaseAddress, XAUTOENCODER_CONTROL_BUS_ADDR_ENCODERWEIGHTS_DATA);
    Data += (u64)XAutoencoder_ReadReg(InstancePtr->Control_bus_BaseAddress, XAUTOENCODER_CONTROL_BUS_ADDR_ENCODERWEIGHTS_DATA + 4) << 32;
    return Data;
}

void XAutoencoder_Set_DecoderWeights(XAutoencoder *InstancePtr, u64 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XAutoencoder_WriteReg(InstancePtr->Control_bus_BaseAddress, XAUTOENCODER_CONTROL_BUS_ADDR_DECODERWEIGHTS_DATA, (u32)(Data));
    XAutoencoder_WriteReg(InstancePtr->Control_bus_BaseAddress, XAUTOENCODER_CONTROL_BUS_ADDR_DECODERWEIGHTS_DATA + 4, (u32)(Data >> 32));
}

u64 XAutoencoder_Get_DecoderWeights(XAutoencoder *InstancePtr) {
    u64 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XAutoencoder_ReadReg(InstancePtr->Control_bus_BaseAddress, XAUTOENCODER_CONTROL_BUS_ADDR_DECODERWEIGHTS_DATA);
    Data += (u64)XAutoencoder_ReadReg(InstancePtr->Control_bus_BaseAddress, XAUTOENCODER_CONTROL_BUS_ADDR_DECODERWEIGHTS_DATA + 4) << 32;
    return Data;
}
