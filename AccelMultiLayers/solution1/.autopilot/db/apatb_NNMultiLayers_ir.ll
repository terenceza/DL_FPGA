; ModuleID = 'C:/Users/Terence/Desktop/AccelMultiLayers/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_NNMultiLayers_ir(%"struct.ap_fixed<1, 16, AP_RND_ZERO, AP_WRAP, 0>"* noalias nocapture nonnull readonly %DataIn, i32* noalias nocapture nonnull readonly %DataDimensionP, i32* noalias nocapture nonnull readonly %HiddenDimensionP, %"struct.ap_fixed<1, 16, AP_RND_ZERO, AP_WRAP, 0>"* noalias nocapture nonnull readonly %EncWeights, %"struct.ap_fixed<1, 16, AP_RND_ZERO, AP_WRAP, 0>"* noalias nocapture nonnull readonly %DecWeights, %"struct.ap_fixed<1, 16, AP_RND_ZERO, AP_WRAP, 0>"* noalias nocapture nonnull readonly %LearningRateP, %"struct.ap_fixed<1, 16, AP_RND_ZERO, AP_WRAP, 0>"* noalias nocapture nonnull readonly %MomentumP, %"struct.ap_fixed<1, 16, AP_RND_ZERO, AP_WRAP, 0>"* noalias nocapture nonnull readonly %DataOut, %"struct.ap_fixed<1, 16, AP_RND_ZERO, AP_WRAP, 0>"* noalias nocapture nonnull %ErrorP) local_unnamed_addr #0 {
entry:
...
declare void @apatb_NNMultiLayers_hw(i8*, i32*, i32*, i8*, i8*, %"struct.ap_fixed<1, 16, AP_RND_ZERO, AP_WRAP, 0>"*, %"struct.ap_fixed<1, 16, AP_RND_ZERO, AP_WRAP, 0>"*, i8*, %"struct.ap_fixed<1, 16, AP_RND_ZERO, AP_WRAP, 0>"*)
...
define void @NNMultiLayers_hw_stub_wrapper(i8*, i32*, i32*, i8*, i8*, %"struct.ap_fixed<1, 16, AP_RND_ZERO, AP_WRAP, 0>"*, %"struct.ap_fixed<1, 16, AP_RND_ZERO, AP_WRAP, 0>"*, i8*, %"struct.ap_fixed<1, 16, AP_RND_ZERO, AP_WRAP, 0>"*) #5 {
entry:
  ...
  call void @NNMultiLayers_hw_stub(%"struct.ap_fixed<1, 16, AP_RND_ZERO, AP_WRAP, 0>"* %9, i32* %1, i32* %2, %"struct.ap_fixed<1, 16, AP_RND_ZERO, AP_WRAP, 0>"* %10, %"struct.ap_fixed<1, 16, AP_RND_ZERO, AP_WRAP, 0>"* %11, %"struct.ap_fixed<1, 16, AP_RND_ZERO, AP_WRAP, 0>"* %5, %"struct.ap_fixed<1, 16, AP_RND_ZERO, AP_WRAP, 0>"* %6, %"struct.ap_fixed<1, 16, AP_RND_ZERO, AP_WRAP, 0>"* %12, %"struct.ap_fixed<1, 16, AP_RND_ZERO, AP_WRAP, 0>"* %8)
...
declare void @NNMultiLayers_hw_stub(%"struct.ap_fixed<1, 16, AP_RND_ZERO, AP_WRAP, 0>"*, i32*, i32*, %"struct.ap_fixed<1, 16, AP_RND_ZERO, AP_WRAP, 0>"*, %"struct.ap_fixed<1, 16, AP_RND_ZERO, AP_WRAP, 0>"*, %"struct.ap_fixed<1, 16, AP_RND_ZERO, AP_WRAP, 0>"*, %"struct.ap_fixed<1, 16, AP_RND_ZERO, AP_WRAP, 0>"*, %"struct.ap_fixed<1, 16, AP_RND_ZERO, AP_WRAP, 0>"*, %"struct.ap_fixed<1, 16, AP_RND_ZERO, AP_WRAP, 0>"*)
