...
module NNMultiLayers_BackPropagateEncoderWeights (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
assign empty_52_fu_1367_p1 = d_fu_278[1:0];

assign icmp_ln304_fu_1355_p2 = ((d_fu_278 == 3'd4) ? 1'b1 : 1'b0);

assign icmp_ln307_fu_1389_p2 = ((h_reg_976 == 4'd10) ? 1'b1 : 1'b0);

assign tmp_3_fu_1371_p4 = {{{empty_52_fu_1367_p1}, {empty_52_fu_1367_p1}}, {1'd0}};
...
endmodule //NNMultiLayers_BackPropagateEncoderWeights
