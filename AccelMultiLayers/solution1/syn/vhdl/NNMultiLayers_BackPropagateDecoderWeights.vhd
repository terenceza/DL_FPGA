...
entity NNMultiLayers_BackPropagateDecoderWeights is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of NNMultiLayers_BackPropagateDecoderWeights is 
...
attribute shreg_extract : string;
    ...
    signal empty_54_fu_1367_p1 : STD_LOGIC_VECTOR (1 downto 0);
    ...
    component NNMultiLayers_mux_406_1_1_1 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    mux_406_1_1_1_U180 : component NNMultiLayers_mux_406_1_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 1,
